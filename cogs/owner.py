...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes Rory The Reapers's core settings"""
    ...
    async def prefix(self, ctx, *prefixes):
        """Sets Rory The Reaper's global prefixes
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets Rory The Reaper's prefixes for this server
    ...
    async def nickname(self, ctx, *, nickname=""):
        """Sets Rory The Reaper's nickname
    ...
    async def game(self, ctx, *, game=None):
        """Sets Rory The Reaper's playing status
    ...
    async def stream(self, ctx, streamer=None, *, stream_title=None):
        """Sets Rory The Reaper's streaming status
    ...
    async def _token(self, token):
        """Sets Rory The Reaper's login token"""
        if len(token) < 50:
    ...
    async def _blacklist_add(self, user: GlobalUser):
        """Adds user to Rory The Reaper's global blacklist"""
    ...
    async def _blacklist_remove(self, user: GlobalUser):
        """Removes user from Rory The Reaper's global blacklist"""
    ...
    async def _whitelist_add(self, user: GlobalUser):
        """Adds user to Rory The Reaper's global whitelist"""
    ...
    async def _whitelist_remove(self, user: GlobalUser):
        """Removes user from Rory The Reaper's global whitelist"""
    ...
    async def restart(self, silently : bool=False):
        """Attempts to restart Rory The Reaper
    ...
    @commands.command()
    async def info(self):
        """Shows info about Rory The Reaper"""
        ...
        embed.add_field(name="About Rory The Reaper", value=about, inline=False)
        embed.set_footer(text="Today we bring a new Bot to an Old World, We are getting better since 10 Jan 2018 (over "
    ...
    async def uptime(self):
        """Shows Rory The Reaper's uptime"""
    ...
    async def version(self):
        """Shows Rory The Reaper's current version"""
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of Rory The Reaper hasn't been installed with git."
